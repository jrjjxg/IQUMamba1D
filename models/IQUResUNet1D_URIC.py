"""IQUResUNet1D_URIC - ResUNet1D with an unrolled residual IC refinement head."""
...
class IQUResUNet1D_URIC(IQUResUNet1D):
    """Pure convolutional ResUNet followed by URIC refinement.

    The ResUNet backbone first predicts coarse separated IQ sources. A compact
    unrolled residual interference-cancellation head then iteratively refines
    those estimates using the original mixture as a receiver-inspired anchor.
    """
