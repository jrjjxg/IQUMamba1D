"""IQUMamba1D_URIC - stage4 IQUMamba followed by URIC refinement."""
...
class IQUMamba1D_URIC(IQUMamba1D):
    """Original IQUMamba backbone plus unrolled residual IC output refinement."""
    ...
    def __init__(
        ...
        ric_num_steps: int = 2,
        ric_hidden_channels: int = 32,
        ric_kernel_size: int = 5,
        ric_dropout: float = 0.0,
        ric_tied_steps: bool = True,
        ric_step_init: float = 0.3,
